...
## About
This repository contains a sample application project built on top of the QuidPHP frameword. This application is using LemurCms for content management. It also offers a script to run the full QuidPHP test suite.
