...
- [scss/app/_include.scss](scss/app/_include.scss) - Scss stylesheet for declaring variables and mixins
...
2. Update the scheme hosts and database parameters within the **env.php** file.
